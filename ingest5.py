                ...
                "content": [
                    {
                        ...
                        "text": (
                            ...
                            "特に円グラフや表の数値は重要です。数値のドット（.）を見落とさないよう注意してください（例：6.1%を61%と間違えないこと）。"
                            "グラフ内にある精油名、成分名とそれぞれの含有率（％）を、漏れなく正確にリストアップしてください。割合が小さい項目も省略せず、全て記述すること。"
                            "表においては、**Markdownテーブル形式**で出力してください。"
                            "この画像に含まれる全ての項目を書き出すまで、終了しないでください。途中で要約したり、『他は省略』といった記述をしたりすることは禁止します。"
                        ),
                    },
                    {
                        "type": "image_url",
